...
class TopDayData extends Widget {
  ...
  public function render() {
    ...
    $idSite = $_GET['idSite'];
    $date = $_GET['date'];
    $sql = "select id as nb_hits,datum,title,url,pageimpressions as nb_visits,unique_pageimpressions as nb_uniq_visitors from klambt_day_data where site_id=".$idSite." and datum = '".$date."' group by url order by pageimpressions desc limit 20";
    $cache=new WKCache();
