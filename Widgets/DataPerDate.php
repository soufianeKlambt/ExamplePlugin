...
class DataPerDate extends Widget {
  ...
  public function render() {
    ...
    $sql = 'SELECT * FROM klambt_day_data INNER JOIN matomo_site ON matomo_site.idsite = klambt_day_data.site_id where klambt_day_data.datum'.$condition.' and site_id='.$idSite." limit 10";
